...
<%
    ...
    String nickname = "";
    String profileImage = "circle.png"; // 기본 프로필 이미지
    String interests = "없음"; // 관심분야 기본값
    int postCount = 0;     
    int answeredCount = 0; 
    ...
    try {
        ...
        if (userRs.next()) {
            ...
            interests = userRs.getString("interests");
    ...
    <div class="box" id="post-container">
        <div class="profile-header">
            ...
            <div class="profile-details">
                <p>
                    <b id="nickname" style="font-size:20px;"><%= nickname %></b>
                    <span>
                        ...
                        <%
                            if (interests != null && !interests.trim().isEmpty()) {
                                ...
                                for(int i = 0; i < interestArray.length; i++) {
                                    out.print(interestArray[i].trim());
            ...
            <a href="post.jsp?post_id=<%= postId %>" class="post-link">
                ...
                <div class="post-header">
                    <a href="profile.jsp?user_id=<%= userIdFromDB %>">
                        <img src="<%= (profileImage != null && !profileImage.isEmpty()) ? profileImage : "circle.png" %>" alt="프로필 이미지" class="profile-pic" />
                        <span style="font-size:20px;"><%= (nickname != null) ? nickname : "닉네임 없음" %></span>
                    </a>
                    <div>
