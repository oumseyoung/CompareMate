...
<body>
  <header>
    <div class="header-container">
      ...
      <div class="up">
        ...
        <img src="trash.png" alt="휴지통" class="trash" onclick="clearAlerts()" />
  ...
  <main>
    <form action="post_new_send" method="POST" enctype="multipart/form-data">
      <h1>게시글 작성</h1>
        ...
        <div class="poll-layout">
          <div class="poll-content">
            ...
            <div class="poll-settings">
              ...
              <label><input type="checkbox" name="notify" value="1"> 투표 종료 알림 받기</label>
            </div>
          </div>
      ...
      <div class="form-actions">
        <button type="button" id="cancel" class="cancel" onclick="location.href='main.jsp'">취소</button>
